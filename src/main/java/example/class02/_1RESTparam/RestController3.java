...
public class RestController3 {
    ...
    @GetMapping("/doget1") // [GET] http://localhost:8080/class02/doget1?name=유재석
    ...
    @GetMapping("/doget2") // [GET] http://localhost:8080/class02/doget2?name=유재석
    ...
    // [3]
    @GetMapping("/doget3") // [GET] http://localhost:8080/class02/doget3?name=유재석&age=40
    ...
    @GetMapping("/doget4") // [GET] http://localhost:8080/class02/doget4?name=유재석&age=40
