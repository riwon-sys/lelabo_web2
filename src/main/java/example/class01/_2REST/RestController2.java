...
@RequestMapping( "/class01" ) // 클래스내 메소드들의 공통 URL 지정
public class RestController2 {
    ...
    @GetMapping( "/doget3" ) // http://localhost:8080/class01/doget3
    ...
    @GetMapping("/doget6") // http://localhost:8080/class01/doget6
    //@ResponseBody
